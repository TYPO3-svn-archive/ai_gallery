...
/**
 * TypoScript functions for 'ai_gallery'
 *
 * @author aijko GmbH <info@aijko.de>
 * @package TYPO3
 * @subpackage ai_gallery
 */
class tx_aigallery_tsfunc {
	// Internal.
	 ...
	 * @return string
	 */
	public function tsCountImages($content, $conf)
	{
		// Get image field.
	 ...
	 * @return string
	 */
	public function tsGalleryNavigation($content, $conf)
	{
	 ...
	 * @return string
	 */
	public function tsPaginator($content, $conf)
	{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ai_gallery/classes/class.tx_aigallery_tsfunc.php'])   {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ai_gallery/classes/class.tx_aigallery_tsfunc.php']);
}
